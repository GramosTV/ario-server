...
@Module({
  imports: [MongooseModule.forRoot(`mongodb+srv://ario:ASGek95vYA9LRGvC@ario.upcth.mongodb.net/?retryWrites=true&w=majority&appName=ario`), ProductsModule, ConfigModule.forRoot(), GamesModule, AuthModule, ScheduleModule.forRoot(), SeoPagesModule],
